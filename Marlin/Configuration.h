...
#define STRING_CONFIG_H_AUTHOR "Asher Anand" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Asher's Ender 3"

// Printer's unique ID, used by some programs to differentiate between machines.
// Choose your own or use a service like https://www.uuidgenerator.net/version4
#define MACHINE_UUID "92773fa3-3566-47fd-8a5d-df758cf1439b"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP   260   // (°C) Default nozzle temperature for the G26 Mesh Validation Tool.
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 5, 0, 5, 0 } // (mm) Left, Front, Right, Back insets
